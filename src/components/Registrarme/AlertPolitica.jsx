    ...
    return (       
        <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2} columns={16}>
                ...
                <FormGroup>
                    <FormControlLabel control={<Checkbox defaultChecked />} label="Garantizar la fiabilidad en el proceso de renta" />
                    <FormControlLabel control={<Checkbox defaultChecked />} label="Agilizar el proceso de renta" />
                    <FormControlLabel control={<Checkbox defaultChecked />} label="Facilitar el proceso de contacto y firma de contrato" />
                    <FormControlLabel control={<Checkbox defaultChecked />} label="Facilitar el acceso de pagos de mensualidades" />
                    <FormControlLabel control={<Checkbox defaultChecked />} label="Validar la identidad de los usuarios" />
                </FormGroup>
                <Typography component={'div'} variant="body1" gutterBottom>
